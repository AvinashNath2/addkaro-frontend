...
export default function EditHoldingPage() {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<HoldingFormData>({
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        <form onSubmit={handleSubmit((d) => mutation.mutate(d))} noValidate className="space-y-5">
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. Banner, Digital, Flex" className="input-field" {...register('preferredAdTypes')} />
